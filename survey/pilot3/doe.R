...
# Save design
write_csv(doe, here::here('survey', 'pilot3', 'doe', 'doe.csv'))
...
doe <- read_csv(here::here('survey', 'pilot3', 'doe', 'doe.csv'))
...
# Save trip list
saveRDS(tripDfList, here::here('survey', 'pilot3', 'doe', 'tripDfList.Rds'))
