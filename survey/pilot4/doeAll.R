...
# Save design
write_csv(doe, here::here('survey', 'pilot4', 'survey', 'doeAll.csv'))
...
doe <- read_csv(here::here('survey', 'pilot4', 'survey', 'doeAll.csv'))
...
for (i in 2:length(tripDfList)) {
    ...
    if (trip$respID[1] == respID) {
        ...
        write_csv(tripDf, here::here('survey', 'pilot4', 'survey', 'tripsAll',
