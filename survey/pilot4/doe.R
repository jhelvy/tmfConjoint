...
# Save design
write_csv(doe, here::here('survey', 'pilot4', 'doe', 'doe.csv'))
...
doe <- read_csv(here::here('survey', 'pilot4', 'doe', 'doe.csv'))
...
# Save trip list
saveRDS(tripDfList, here::here('survey', 'pilot4', 'doe', 'tripDfList.Rds'))

# -----------------------------------------------------------------------------
# Read in trip list and save all trips for each respondent as a csv file

tripDfList <- readRDS(here::here('survey', 'pilot4', 'doe', 'tripDfList.Rds'))
...
for (i in 2:length(tripDfList)) {
    ...
    if (trip$respID[1] == respID) {
        ...
        write_csv(tripDf, here::here('survey', 'pilot4', 'doe', 'trips',
