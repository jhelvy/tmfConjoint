...
# Save design
write_csv(doe, here::here('survey', 'pilot4', 'survey', 'doeNoCar.csv'))
...
doe <- read_csv(here::here('survey', 'pilot4', 'survey', 'doeNoCar.csv'))
...
# Save trip list
saveRDS(tripDfList, here::here('survey', 'pilot4', 'survey', 
                               'tripDfListNoCar.Rds'))
...
for (i in 2:length(tripDfList)) {
    ...
    if (trip$respID[1] == respID) {
        ...
        write_csv(tripDf, here::here('survey', 'pilot4', 'survey', 'tripsNoCar',
